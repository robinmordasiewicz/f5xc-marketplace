...
- sync managed files from governance template (#142)
...
- add scripts/pre-commit-local.sh for repo-specific hooks (#132)
...
- sync .pre-commit-config.yaml (#129)
...
- sync managed files from governance template (#105)
...
- correct MDX syntax in plugin-automation documentation (#101)
...
- sync .github/workflows/require-linked-issue.yml (#74)

## [3.5.0] - 2026-02-10

### Added

- onboard to f5xc-template governance and Astro Starlight docs (#47)

### Fixed

- use REPO_ADMIN_TOKEN in release workflow to trigger required checks (#70)
- add concurrency group and stale branch cleanup to release workflow (#66)
...
- sync .gitignore (#58)
- sync .gitignore (#56)
- sync managed files from governance template (#54)
- sync .github/workflows/auto-merge.yml (#52)
- sync managed files from governance template (#50)
- update to MIT license with 2026 copyright (#43)
- update all references for repository rename to f5xc-marketplace
