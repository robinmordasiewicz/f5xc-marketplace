...
description: Common issues and solutions for the F5 Distributed Cloud plugin marketplace
---
...
<details>
<summary>Can I use this with multiple F5 XC tenants?</summary>
...
<details>
<summary>Are my credentials stored?</summary>
...
<details>
<summary>Can I automate without browser?</summary>

The `f5xc-cli` and `f5xc-api` plugins (planned) will provide headless automation. See the [Roadmap](../roadmap/) for availability.

</details>

<details>
<summary>How do I update plugins?</summary>
